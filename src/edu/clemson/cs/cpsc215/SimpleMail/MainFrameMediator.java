...
public class MainFrameMediator {
	 ...
	 * 
	 * @param e		The MouseEvent associated with a click
	 * @param loc	The index of the row clicked
	 */
	 ...
	 * 
	 * @param loc		the index of the contact to edit
	 */
	 ...
	 * 
	 * @param row		the row of the contact to delete
	 */
